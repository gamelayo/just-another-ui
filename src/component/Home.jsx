    ...
    >
      <div className="md:w-[770px] md:h-[233px] flex justify-center flex-col items-center ">
        ...
        <div className="w-[70%] md:w-[331px] md:h-[37px] flex pt-4 justify-around">
          <button className="border border-black flex items-center bg-yellow-400 w-[45%] md:w-[150px] h-[37px] justify-center">
            <span className="pr-1 md:pr-2">Get started</span>
            <FaLongArrowAltRight />
          </button>
          <button className="border border-yellow-400 flex items-center text-yellow-400 w-[45%] md:w-[150px] h-[37px] justify-center">
